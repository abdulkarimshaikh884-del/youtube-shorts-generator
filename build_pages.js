...
.sk-card{display:flex;flex-direction:column;gap:11px;min-width:0}
.sk-thumb{
  display:block;position:relative;aspect-ratio:16/9;
  border-radius:13px;overflow:hidden;background:var(--sh-bg3);
}
...
@media (max-width:640px){
  ...
  .sk-grid{padding:8px 18px 22px;grid-template-columns:1fr;gap:22px}
